...
Taxa do dia: TO_{b,d} = \text{minutos}*{b,d}/1440. Zero = ocioso; 1.440 = 100% - não é erro. Agregação mensal: soma de minutos / 1440 \times N*{\text{dias}}, não média das taxas diárias se o alvo for fração do mês.
...
\mathrm{PMO}*i = \frac{\sum*{c \in i} \text{peso}_c}{T3_i}
